"""DuckDuckGo MCP（原版 TS server 子进程桥）：ddg_get_answer / ddg_search / ddg_search_news / ddg_search_images / ddg_search_videos / ddg_fetch_content / ddg_get_suggestions / ddg_get_definition / ddg_convert_currency"""
import os
import shlex
...
async def _spawn():
    ...
    args = ["-c", f"cd {shlex.quote(str(DUCK_DIR))} && exec bun run src/index.ts"]
